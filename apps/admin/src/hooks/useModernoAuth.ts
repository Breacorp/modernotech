  ...
  useEffect(() => {
    ...
    async function checkAuth() {
      try {
        ...
        // 2. Fallback de sesión local para demo/dev en cliente
        ...
        // En caso de no haber conexión con Supabase en build estático, fallback silencioso a visitante
    ...
    // 3. Suscripción a cambios de sesión en tiempo real
    const {
      data: { subscription },
